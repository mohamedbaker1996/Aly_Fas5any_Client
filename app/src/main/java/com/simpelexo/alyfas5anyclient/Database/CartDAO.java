...
public interface CartDAO {
    ...
    @Query("SELECT * FROM Cart WHERE foodId=:foodId AND uid=:uid AND foodSize=:foodSize")
    Single<CartItem> getItemWithSizeInCart(String uid,String foodId,String foodSize);
